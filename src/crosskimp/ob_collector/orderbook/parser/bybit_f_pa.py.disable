...
이 모듈은 바이빗 선물 거래소의 웹소켓 메시지를 파싱하는 클래스를 제공합니다.
"""
...
class BybitFutureParser(BaseParser):
    """
    바이빗 선물 파서 클래스
    
    바이빗 선물 거래소의 웹소켓 메시지를 파싱하는 클래스입니다.
    ...
    def __init__(self):
        ...
        self.depth_level = BYBIT_FUTURE_CONFIG.get("default_depth", 50)
