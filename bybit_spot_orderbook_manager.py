# file: core/websocket/exchanges/bybit_spot_orderbook_manager.py
...
from core.websocket.base_orderbook_manager import BaseOrderBookManager
from core.websocket.base_orderbook import OrderBook, ValidationResult
